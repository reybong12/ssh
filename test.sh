...
cd /root
wget "https://github.com/atong27/AutoScriptDS/raw/master/Files/Plugins/plugin.tgz"
wget "https://github.com/atong27/AutoScriptDS/raw/master/Files/Menu/bashmenu.zip"
...
# install webmin
cd
wget "https://github.com/atong27/AutoScriptDS/raw/master/Files/Plugins/webmin_1.920_all.deb"
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/atong27/AutoScriptDS/master/Files/Plugins/screenfetch"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/atong27/AutoScriptDeb8/master/Files/Others/issue.net"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://github.com/atong27/AutoScriptDS/raw/master/Files/Plugins/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/atong27/AutoScriptDS/raw/master/Files/Plugins/badvpn-udpgw64"
fi
...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="SBH"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="TWU"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="KingKongVPN"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="admin@kingkongvpn.xyz"|' /etc/openvpn/easy-rsa/vars
